            ...
            <div className="container">
                ...
                <div className="flex gap-2 mb-10">
                    <div className="w-1/2 relative">
                        <input placeholder="اسم الكتاب..." className="px-4 py-3 border border-[#777] w-full rounded-md hover:outline-none" />
                ...
                <h3
                    style={{ fontSize: "28px", color: "#1B1B1B", marginBottom: "10px" }}
